...
from ID3_class_bagged_trees import ID3
import numpy as np 
import random
...
def randforest(X_train,y_train,flags,X_test,y_test,num_rnd_features,iter=50):
    ...
    for t in range(iter):
        ...
        this_id3.fit(this_X_train,this_y_train,w_train,flags,num_rnd_features)
