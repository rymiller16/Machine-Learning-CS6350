...
#Task: SVM in the primal domain using stoahcstic sub gradient descent 
...
def SVM_SSGD(X,y,num_Epochs,C,gamma_o,alpha):
    ...
    for i in range(1,num_Epochs):
        gamma_t = gamma_o/(1+(gamma_o/alpha)*i)
        #gamma_t = (gamma_o)/(1+i)
...
gamma_o = 2.5   #1.5
alpha = 0.001
w, norm_v = SVM_SSGD(X_train,y_train,num_Epochs,C, gamma_o,alpha)
